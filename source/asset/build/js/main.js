      ...
      _c("div", { staticStyle: { margin: "20px 0" } }, [
        _c("form", { staticClass: "bd-search d-flex align-items-center" }, [
          ...
          _c("input", {
            ...
            staticClass: "transition focus:outline-0 border border-transparent focus:bg-white focus:border-gray-300 placeholder-gray-600 rounded-lg bg-grey-lightest py-2 pr-4 pl-4 block w-full appearance-none leading-normal ds-input",
            attrs: {
              type: "search",
              id: "search",
